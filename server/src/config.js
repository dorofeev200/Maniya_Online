...
export const config = {
  ...
  eonline: {
    ...
    balancers: list('EO_BALANCERS', ['alloha', 'videoseed', 'kinopub', 'kinoflix', 'veoveo', 'pidtor', 'solntse', 'filmix', 'filmixtv', 'rezka', 'hdvb', 'rutubemovie', 'vkmovie', 'kodik', 'geosaitebi', 'rhsprem', 'zetflixdb', 'zagonka', 'xvideocdnultra']),
  ...
  skaz: {
    ...
    balancers: list('SKAZ_BALANCERS', list('EO_BALANCERS', ['alloha', 'videoseed', 'kinopub', 'kinoflix', 'veoveo', 'pidtor', 'solntse', 'filmix', 'filmixtv', 'rezka', 'hdvb', 'rutubemovie', 'vkmovie', 'kodik', 'geosaitebi', 'rhsprem', 'zetflixdb', 'zagonka', 'xvideocdnultra'])),
